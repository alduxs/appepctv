      ...
      <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-sm-12">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><strong>Agregar Alumno</strong></li>
          </ol>
        </div>
      </div>
          ...
          <div class="col-lg-12">
            <div class="ibox float-e-margins">
              <div class="ibox-content">
                <form method="post" action="svAlumnos.php" enctype="multipart/form-data" name="form1" id="form1">
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <p><label class="checkbox-inline i-checks"> <input type="radio" value="1" name="estado" checked> <i></i> Activo </label><label class="checkbox-inline i-checks"> <input name="estado" type="radio" value="0" > <i></i> Inactivo </label></p>
                  </div>
                  <div class="hr-line-dashed col-xs-12"></div>
