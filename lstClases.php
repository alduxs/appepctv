	...
	<div id="wrapper">
		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-sm-12">
					<h2>Listar Clases de Equipos</h2>
					<ol class="breadcrumb">
						<li><a href="home.php?seccion=inicio">Home</a></li>
						<li><a href="#">Clases de Equipos</a></li>
						<li class="active"><strong>Listar clases de equipos</strong></li>
					</ol>
				</div>
			</div>
					...
					<div class="col-lg-12">
						<div class="ibox float-e-margins">
							<div class="ibox-content">
								<form name="frm" method="post" action="svClases.php">
									...
									<table id="table"
										...
										<tbody>
											...
											<?php while ($arrContenido = $rsCont->fetch(PDO::FETCH_BOTH)) { ?>
												<tr>
													<td><?php echo $arrContenido["ecl_id"]; ?></td>
													<?php if ($arrContenido["eqr_id_padre"] == 0) { ?>
													...
													<?php } else { ?>
														...
														$query2 = "SELECT ecl_nombre FROM equipo_clases WHERE ecl_id = " . $arrContenido["eqr_id_padre"];
													...
													<td class="tooltip-demo">
														<a href="updClases.php?seccion=clases&id=<?php echo $arrContenido["ecl_id"]; ?>&intPage=<?php echo $intPage ?>" class="btn btn-primary btn-bitbucket" data-toggle="tooltip" data-placement="bottom" title="Editar"><i class="fa fa-pencil"></i></a>
														<a href="javascript:;" onclick="delRegistro('<?php echo $arrContenido["ecl_id"] ?>','','clases',<?php echo $intPage ?>);" class="btn btn-primary btn-bitbucket" data-toggle="tooltip" data-placement="bottom" title="Borrar"><i class="fa fa-trash-o"></i></a>
													</td>
												</tr>
												<?php $intCounter++; ?>
											<?php } ?>
