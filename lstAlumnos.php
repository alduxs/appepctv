			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-sm-12">
					...
					<ol class="breadcrumb">
						...
						<li class="active"><strong>Listar Alumnos</strong></li>
					</ol>
				</div>
			</div>
					...
					<div class="col-lg-12">
						<div class="ibox float-e-margins">
							<div class="ibox-content">
								<form name="frm" method="post" action="svAlumnos.php">
										...
										<tbody>
											...
											<?php while ($arrContenido = $rsCont->fetch(PDO::FETCH_BOTH)) { ?>
												<tr>
                                                    ...
                                                    <td><?php echo $arrContenido["estudiantes_id"]; ?></td>
													<td><?php echo $arrContenido["estudiantes_apellido"]; ?></td>
													<td><?php echo $arrContenido["estudiantes_name"]; ?></td>
                                                    <td><?php echo $arrContenido["estudiantes_email"]; ?></td>
													

												

													<td class="tooltip-demo">
														<a class="btn btn-primary btn-bitbucket" href="#" onclick="openModal(<?php echo $arrContenido["estudiantes_id"] ?>)" data-toggle="tooltip" data-placement="bottom" title="Ver"><i class="fa fa-search"></i></a>
														<a href="updAlumnos.php?seccion=clases&id=<?php echo $arrContenido["estudiantes_id"]; ?>&intPage=<?php //echo $intPage ?>" class="btn btn-primary btn-bitbucket" data-toggle="tooltip" data-placement="bottom" title="Editar"><i class="fa fa-pencil"></i></a>
														<a href="javascript:;" onclick="delRegistro('<?php echo $arrContenido["estudiantes_id"] ?>','','alumnos',<?php //echo $intPage ?>);" class="btn btn-primary btn-bitbucket" data-toggle="tooltip" data-placement="bottom" title="Borrar"><i class="fa fa-trash-o"></i></a>
													</td>
												</tr>
												<?php $intCounter++; ?>
											<?php } ?>
