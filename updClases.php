...
<body>
  <div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
      ...
      <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-sm-12">
          <h2>Modificar Clase de Equipo</h2>
          <ol class="breadcrumb">
            <li><a href="home.php?seccion=inicio">Home</a></li>
            <li><a href="#">Clases de Equipos</a></li>
            <li class="active"><strong>Modificar clase de equipo</strong></li>
          </ol>
        </div>
      </div>
          ...
          <div class="col-lg-12">
            <div class="ibox float-e-margins">
              <div class="ibox-content">
                <form action="svClases.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                  ...
                  <div class="form-group col-xs-12">
                    <label for="clase">Clase Superior</label>
                    <select name="clase" class="form-control" id="clase">

                      <option value="0" <?php if($arrCont["eqr_id_padre"]==0){?>selected<?php }?>>Sin clase superior</option>
                      <?php
                      $queryPost = "SELECT * 
                                    FROM equipo_clases ec
                                    LEFT JOIN equipos_clases_relacion ecr ON ecr.eqr_id_clase = ec.ecl_id
                      ...
                      <?php while ($arrPost = $rsPost->fetch(PDO::FETCH_BOTH)) { ?>
                        <option value="<?php echo $arrPost["ecl_id"] ?>" <?php if($arrCont["eqr_id_padre"]==$arrPost["ecl_id"]){?>selected<?php }?>><?php echo $arrPost["ecl_nombre"] ?></option>
                      <?php } ?>
                    </select>
                  </div>
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <input type="text" name="nombre" id="nombre" class="form-control" value="<?php echo $arrCont["ecl_nombre"] ?>">
                  </div>
                  <div class="hr-line-dashed col-xs-12"></div>
                  ...
                  <div class="form-group text-center">
                    ...
                    <a href="lstClases.php?seccion=clases" class="btn btn-primary">Cancelar</a>
                  </div>
                </form>
              </div>
            </div>
  ...
  <script>
    ...
    function validClase() {
      ...
      $.ajax({
          method: "POST",
          url: "validaciones/validClase.php",
          data: {
            tipo: 2,
            id:id,
            nombre: nombre
        ...
        .done(function(data) {
          if (data == 0) {
            ...
            alert("Hay una clase con el nombre: " + nombre);
          }
        });
