...
$file = fopen("files/ingresantes.csv", "r");
while (($contenido = fgetcsv($file, '', ';')) !== FALSE) {
    $numero = count($contenido);

    

    $arrData[0] = '';
    for ($c = 0; $c < $numero; $c++) {
        $arrData[$c + 1] = trim($contenido[$c]);
    }
    $arrData[3] = limpiaCaracteresDni($arrData[3]);
    $arrData[6] = 1;


    $query = "SELECT * FROM data_estudiantes WHERE estudiantes_dni = " . $arrData[3];
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-sm-12">
                    <h2>Importar Alumnos - Paso 3</h2>
                    <ol class="breadcrumb">
                        <li><a href="home.php?seccion=inicio">Home</a></li>
                        <li><a href="#">Importar Alumnos</a></li>
                        <li class="active"><strong>Importar Alumnos - Paso 3</strong></li>
                    </ol>
                </div>
            </div>
                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                ...
                                <div class="alert alert-success" role="alert">
                                    <p><strong>Cargados:</strong> <?php echo $cargados; ?></p>
                                    <p><strong>Repetidos:</strong> <?php echo $repetidos; ?></p>
                                    <p><strong>Total:</strong> <?php echo $totales; ?></p>
                                </div>


                                <div class="form-group text-center">
                                    <a href="lstAlumnos.php?seccion=alumnos" class="btn btn-primary">Listar Alumnos</a>
                                </div>
                            </div>
                        </div>
                    </div>
