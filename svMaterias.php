...
switch ($strOperacion) {
    case 'I':
        ...
        $arrData[1] = sanStrHtml($_POST["profesor"]);
        $arrData[2] = sanStrHtml($_POST["nombre"]);
        //

        $Insert_row = new General();
        $query = "INSERT INTO data_materia (materia_id_profesor,materia_nombre) VALUES (?,?)";
    ...
    case 'U':
        ...
        $query = "UPDATE data_materia SET materia_id_profesor = ?,materia_nombre = ? WHERE materia_id = ?";
...
//
header("Location: lstMaterias.php?seccion=materias");
