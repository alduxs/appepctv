...
//
$objCont = new General();
$query = "SELECT * FROM categorias WHERE cat_id=" . $intIdCont;
      ...
      <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-sm-12">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><strong>Modificar categoría</strong></li>
          </ol>
        </div>
      </div>
          ...
          <div class="col-lg-12">
            <div class="ibox float-e-margins">
              <div class="ibox-content">
                <form action="svCategorias.php" method="post" enctype="multipart/form-data" name="form1">
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <input type="text" name="nombre" id="nombre" class="form-control" value="<?php echo $arrCont["cat_nombre"] ?>">
                  </div>
                  <div class="hr-line-dashed col-xs-12"></div>

                  <div class="form-group text-center">
                    <input name="agregar" type="submit" class="btn btn-primary" id="agregar" value="Enviar">
                    <a href="lstCategorias.php?seccion=categorias" class="btn btn-primary">Cancelar</a>
                  </div>
                </form>
              </div>
            </div>
