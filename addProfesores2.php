...
<body>
      ...
      <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-sm-12">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><strong>Agregar Profesor</strong></li>
          </ol>
        </div>
      </div>
          ...
          <div class="col-lg-12">
            <div class="ibox float-e-margins">
              <div class="ibox-content">
                <form method="post" action="svProfesores.php" enctype="multipart/form-data" name="form1" id="form1">
  ...
  <script src="js/plugin-bootstrap3/index.min.js"></script>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function(e) {
      FormValidation.formValidation(document.getElementById('form1'), {
        fields: {
          nombre: {
            validators: {
              notEmpty: {
          ...
          apellido: {
            validators: {
              notEmpty: {
                message: 'El apllido es obligatorio',
              },
            },
          },
        },
