  ...
  <div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
      ...
      <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-sm-12">
          <h2>Duplicar Equipo</h2>
          <ol class="breadcrumb">
            <li><a href="home.php?seccion=inicio">Home</a></li>
            <li><a href="#">Equipos</a></li>
            <li class="active"><strong>Duplicar equipo</strong></li>
          </ol>
        </div>
      </div>
              ...
              <div class="ibox-content">
                <form action="svEquipos.php" method="post" enctype="multipart/form-data" name="form1">
                  ...
                  <!--<div class="form-group col-xs-12">
                    ...
                    <p><label class="checkbox-inline i-checks"> <input type="radio" value="1" name="estado" <?php if (!(strcmp($arrCont["eq_estado"], 1))) { echo "checked=\"checked\""; } ?>> <i></i> Disponible </label><label class="checkbox-inline i-checks"> <input name="estado" type="radio" value="2" <?php if (!(strcmp($arrCont["eq_estado"], 2))) { echo "checked=\"checked\""; } ?>> <i></i> Solicitado </label><label class="checkbox-inline i-checks"> <input name="estado" type="radio" value="3" <?php if (!(strcmp($arrCont["eq_estado"], 3))) { echo "checked=\"checked\""; } ?>> <i></i> Reservado </label><label class="checkbox-inline i-checks"> <input name="estado" type="radio" value="4" <?php if (!(strcmp($arrCont["eq_estado"], 4))) { echo "checked=\"checked\""; } ?>> <i></i> En uso </label></p>
                  </div>
                  ...
                  <div class="form-group text-center">
                    <input name="agregar" type="submit" class="btn btn-primary" id="agregar" value="Duplicar">
